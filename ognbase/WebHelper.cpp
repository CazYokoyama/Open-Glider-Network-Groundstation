...
<tr><th align=left>Manuel Roesel (manuel.roesel@ros-it.ch)</th><td align=left>OGN Groundstation Function</td></tr>\
</table>\
<hr>\
...
<option %s value='%d'>Ground</option>\
...
<option %s value='%d'>UAV</option>\
  ...
  (settings->mode == SOFTRF_MODE_GROUND ? "selected" : "") , SOFTRF_MODE_GROUND,
...
void handleRoot() {
  ...
  <head>\
    <meta name='viewport' content='width=device-width, initial-scale=1'>\
    <title>OGN Ground Station</title>\
  </head>\
<body>\
 <table width=100%%>\
  <tr><!-- <td align=left><h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h1></td> -->\
  <td align=center><h1>OGN Ground Station</h1></td>\
 ...
 "<tr><th align=left>Uptime</th><td align=right>%02d:%02d:%02d</td></tr>\
  ...
  <tr><th align=left>Voltage</th><td align=right><font color=%s>%s</font></td></tr>\
 </table>\
 <table width=100%%>\
