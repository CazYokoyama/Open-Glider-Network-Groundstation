            ...
            if (C_Version.isUpdated())
            {
                ...
                else if (atoi(C_Version.value()) == PSRFC_VERSION)
                {
                    ...
                    if (C_AcftType.isUpdated())
                    {
                        ...
                        Serial.print(F("AcftType = "));
                        Serial.println(settings->aircraft_type);
                        cfg_is_updated = true;
                    }
                    ...
                    if (C_PowerSave.isUpdated())
                    {
                        ...
                        Serial.println(settings->power_save);
                        cfg_is_updated = true;
                    }
