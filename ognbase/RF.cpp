...
byte RF_setup(void)
{
    ...
    if (ogn_band == RF_BAND_AUTO)
    {
        ...
        if (rf_chip                &&
            ...
            rf_chip != &nrf905_ops &&
#endif
            ogn_protocol_1 == RF_PROTOCOL_P3I)
...
static void uatm_setup()
{
    ...
    ogn_protocol_1 = RF_PROTOCOL_ADSB_UAT;
...
{
#if !defined(EXCLUDE_OGLEP3)
    if (ogn_protocol_1 != RF_PROTOCOL_ADSB_UAT &&
...
void RFM_Select(void)
{
    hal_pin_nss(0);
}

void RFM_Deselect(void)
{
    hal_pin_nss(1);
}
...
bool RFM_IRQ_isOn(void)
{
    return lmic_pins.dio[0] == LMIC_UNUSED_PIN ? \
...
static void ognrf_setup()
{
    ...
    ogn_protocol_1 = RF_PROTOCOL_OGNTP;
