...
typedef struct _type_4
{
    ...
    pb_callback_t wind_heading;
    pb_callback_t s_scale;
    pb_callback_t wind_speed;
    pb_callback_t g_scale;
    pb_callback_t wind_gusts;
    pb_callback_t hunidity;
    pb_callback_t barometic_lsb;
    pb_callback_t barometic_msb;
} type_4;
...
#define type_4_init_default                      {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
...
#define type_4_init_zero                         {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
...
#define type_4_temperature_tag                   5
#define type_4_wind_heading_tag                  6
#define type_4_s_scale_tag                       7
#define type_4_wind_speed_tag                    8
#define type_4_g_scale_tag                       9
#define type_4_wind_gusts_tag                    10
#define type_4_hunidity_tag                      11
#define type_4_barometic_lsb_tag                 12
#define type_4_barometic_msb_tag                 13
...
#define type_4_FIELDLIST(X, a) \
    ...
    X(a, CALLBACK, OPTIONAL, BYTES, temperature, 5) \
    X(a, CALLBACK, OPTIONAL, BYTES, wind_heading, 6) \
    X(a, CALLBACK, OPTIONAL, BYTES, s_scale, 7) \
    X(a, CALLBACK, OPTIONAL, BYTES, wind_speed, 8) \
    X(a, CALLBACK, OPTIONAL, BYTES, g_scale, 9) \
    X(a, CALLBACK, OPTIONAL, BYTES, wind_gusts, 10) \
    X(a, CALLBACK, OPTIONAL, BYTES, hunidity, 11) \
    X(a, CALLBACK, OPTIONAL, BYTES, barometic_lsb, 12) \
    X(a, CALLBACK, OPTIONAL, BYTES, barometic_msb, 13)
